...
export class AppComponent {
  ...
  getUnitList(): void {
    ...
    this.obsUnit = this.http.get<Unit[]>('https://3000-ffff4018-4c8e-4e8a-80dd-36ce7a19e6a7.ws-eu01.gitpod.io/users');
  ...
  addUnit(newUnit: HTMLInputElement, newCost: HTMLInputElement, newHitSpeed: HTMLInputElement): boolean {
    ...
    this.postObserver = this.http.post('https://3000-ffff4018-4c8e-4e8a-80dd-36ce7a19e6a7.ws-eu01.gitpod.io/users', JSON.stringify(newData),headers)
